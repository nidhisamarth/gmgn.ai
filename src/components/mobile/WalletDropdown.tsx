...
const WalletDropdown = ({ isOpen, onClose }: WalletDropdownProps) => {
  ...
  const handleItemClick = async (item: string) => {
    ...
    // Handle other item functionality here
    onClose();
  };
        ...
        <div className="py-2">
          ...
          >
            ...
            >
              <path
                fillRule="evenodd"
                d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm1 2a1 1 0 011-1h8a1 1 0 011 1v6a1 1 0 01-1 1H6a1 1 0 01-1-1V6z"
                clipRule="evenodd"
              />
            </svg>
